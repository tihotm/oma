...
def test_08_future_trust_epoch_is_blocked(): c,r,a=_trust(2,2); c=TrustContext("ctx-v2",1,2,2,2,TemporalHighWater(1,2,2,2)); assert evaluate_trust(c,r,a).decision is TrustDecision.BLOCK
