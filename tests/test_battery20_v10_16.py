...
def test_string_compromised_status_is_treated_like_active_root():
    context=TrustContext("time",1,1,5,1,TemporalHighWater(1,1,5,1))
    root=TrustRoot("root",1,"COMPROMISED",activated_epoch=0,compromised_epoch=1)
    artifact=SignedArtifact("a","root",1,1,5,1,5,10)
